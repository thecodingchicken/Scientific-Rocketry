...
func init()
{
	...
	// I used temporary recipes since I will be using CraftTweaker for the recipes anyway
	panel()
		.name("leadstone")
		.height(6 / 16.0)
		.generation("1")
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Leadstone Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Hardened Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Reinforced Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Signalum Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
			.bind('8', item("solarflux:solar_panel_8"))
			.bind('c', item("emerald_ore"))
			.bind('h', item("skull", 5))
		.build(2);
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Resonant Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
			.bind('8', item("solarflux:solar_panel_8"))
			.bind('c', item("diamond_ore"))
			.bind('h', item("skull", 5))
		.build(2);
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Iridium Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
			.bind('8', item("solarflux:solar_panel_8"))
			.bind('c', item("iron_ore"))
			.bind('h', item("skull", 5))
		.build(2);
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Osgloglas Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
			.bind('8', item("solarflux:solar_panel_8"))
			.bind('c', item("gold_ore"))
			.bind('h', item("skull", 5))
		.build(2);
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Mithril Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
			.bind('8', item("solarflux:solar_panel_8"))
			.bind('c', item("iron_ingot"))
			.bind('h', item("skull", 5))
		.build(2);
	...
	.buildAndRegister()
		.langBuilder()
			.put(english, "Adamantium Solar Panel")
			.build()
		.recipeBuilder()
			.shape("ppp", "8c8", "8h8")
			.bind('p', item("solarflux", "photovoltaic_cell_6"))
			.bind('8', item("solarflux:solar_panel_8"))
			.bind('c', item("gold_ingot"))
			.bind('h', item("skull", 5))
		.build(2);
}